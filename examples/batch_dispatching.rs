...
//!
//! The Batch is a feature that allow to control the dispatching of a group of systems.
//!
...
//! The SayHelloSystem is requesting the resources **TomatoStore** and **PotatoStore**,
//! which are also requested by the other two systems inside the batch and by the batch
//! controller itself.
//!
//! This to demonstrate that the dispatcher is able to correctly organize, their execution.
//!
//! Is also showed how to use a custom BatchControllerSystem.
//! Check the **CustomBatchControllerSystem** which execute its inner Systems three times.
//!
